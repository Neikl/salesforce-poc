...
public class pageobject1 {
	...
	@ChoiceListType()
	@FindBy(xpath = "//select[@name='ctl00$mainContent$ddl_originStation1']")
	public WebElement From;
	@ChoiceListType()
	@FindBy(xpath = "//select[@id='ctl00_mainContent_ddl_destinationStation1']")
	public WebElement To;
	@ButtonType()
	@JavascriptBy(jspath = "return document.querySelector('div.book > div > div.picker-first2 > button')")
	public WebElement Deprt;
	@LinkType()
	@FindBy(linkText = "21")
	public WebElement _21;
	@TextType()
	@FindBy(xpath = "//label[normalize-space(.)='PASSENGERS']/following-sibling::div[1]")
